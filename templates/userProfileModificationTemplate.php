			<form class="form-signin" action="index.php?controller=user&user=<?php echo $id ?>&action=validerModificationProfil" method="post">
				<div class="form-signin" id="content">

					<h2 class="form-signin-heading">Modification de profil</h2>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">							
							<input type="text" name="newNom" class="form-control" value="<?php echo $user->nom(); ?>" autofocus>
						</div>
					</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<input type="email" name="newMail" class="form-control" placeholder="Email" value="<?php echo $user->mail(); ?>">
						</div>
					</div>
